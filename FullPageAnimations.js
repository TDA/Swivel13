...
var BringToViewAnimations = "rotateInLeft";
var RemoveFromViewAnimations = "rotateOutRight";
...
var BodyOnClickHandler = function(event) {
	...
	if (anchorTag != null) {
		...
		TriggerBodyRemoveFromViewAnimation(RemoveFromViewAnimations, anchorTag.href);
	}
};
...
var SetupBodyBringToViewAnimation = function(animName) {
	...
	if (animName == null) {
		animName = BringToViewAnimations;
	}
